      ...
      <div className="container">
        <div className="row justify-content-center mb-4">
            ...
            <div className="col-md-7 text-center">
                <p className="lead mb-4">Con más de 40 años de trayectoria en el mercado ganadero argentino, Alfredo S Modino ha construido una reputación basada en la confianza, el conocimiento profundo del sector y el compromiso con cada cliente.</p>
